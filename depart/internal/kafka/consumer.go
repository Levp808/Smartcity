...
func NewPetitionListener(
	ctx context.Context,
	config Config,
	departmentService DepartmentService,
) (*PetitionListener, error) {
	// Наш обработчик реализующий интерфейс sarama.orderStatusChangedHandler
	handler := NewPetitionHandler(departmentService)
...
func (c *PetitionListener) Run(ctx context.Context) {
