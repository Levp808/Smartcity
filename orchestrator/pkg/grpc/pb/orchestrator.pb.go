...
// 	protoc        v5.28.3
// source: orchestrator_v1/orchestrator.proto
...
func (x *ModerationRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ModerationRequest) GetLocation() string {
	if x != nil {
		return x.Location
	}
	return ""
...
func (x *ModerationRequest) GetDescription() string {
	if x != nil {
...
type ModerationResponse struct {
	...
	Depart string `protobuf:"bytes,1,opt,name=depart,proto3" json:"depart,omitempty"`
}
...
func (x *ModerationResponse) GetDepart() string {
	if x != nil {
		return x.Depart
	}
	return ""
...
var file_orchestrator_v1_orchestrator_proto_rawDesc = []byte{
	0x0a, 0x22, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x76,
	0x31, 0x2f, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x61, 0x0a, 0x11, 0x4d, 0x6f, 0x64,
	...
	,
...
var file_orchestrator_v1_orchestrator_proto_goTypes = []any{
	(*ModerationRequest)(nil),  // 0: api.ModerationRequest
	(*ModerationResponse)(nil), // 1: api.ModerationResponse
}
var file_orchestrator_v1_orchestrator_proto_depIdxs = []int32{
	0, // 0: api.OrchestratorService.Moderation:input_type -> api.ModerationRequest
	1, // 1: api.OrchestratorService.Moderation:output_type -> api.ModerationResponse
